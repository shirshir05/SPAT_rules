class n10005674{
    public String post() {
        ...
        try {
            ...
            String line;
            line = rd.readLine();
            boolean GHqLhptJ = line == null || line.length() < 8;
            if (GHqLhptJ || !line.substring(0, 8).equals("SUCCESS:")) return "Unknown error in publishing the post"; else  return "*Publish successful.! The link to your post is.: " + "http://pastebin.ca/" + line.substring(8);
